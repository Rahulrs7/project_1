...
$con = mysqli_connect("localhost", "root", "rahul123", "flight");
...
?>
  ...
  <center>
    <h3>Airpot Authority of India</h3>
  </center>
  <center>
  ...
  <body>
    ...
    <center><img src='images/maxx.jpg' class='img-thumbnail' width='500px' style='height:auto; float:right;display:flex'></center>
        ...
        <div class="col-sm-12">
          <center>
            <table class="table table-bordered" style="font-family: Verdana">
              ...
              <tr>
                <td>
                  <font style="font-family: Verdana;">Meail Choice</font>
                </td>
